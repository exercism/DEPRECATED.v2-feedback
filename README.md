...
If Go is your jam, then we have all sorts of things you can help out with, primarily in the [exercism/cli](https://github.com/exercism/cli) and [exercism/configlet](https://github.com/exercism/configlet) code bases.
